...
public enum WaveformSeekBarConfig {
    /**
    ...
    public struct Dampening {
        ...
        /// Build a new `WaveformSeekBarConfig.Dampening` with only the given parameters replaced.
    ...
    public struct Configuration {
        ...
        /// Build a new `WaveformSeekBarConfig.Configuration` with only the given parameters replaced.
