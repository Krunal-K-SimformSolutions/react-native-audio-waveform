...
struct WaveformSeekBarAnalysis {
    let amplitudes: [Float]
    let fft: [TempiFFT]?
}

/// Calculates the waveform of the initialized asset URL.
public class WaveformSeekBarAnalyzer {
...
// MARK: - Private
fileprivate extension WaveformSeekBarAnalyzer {
    func waveformSamples(
        count requiredNumberOfSamples: Int,
        qos: DispatchQoS.QoSClass,
        fftBands: Int?,
        completionHandler: @escaping (_ analysis: WaveformSeekBarAnalysis?) -> ()) {
    ...
    func extract(totalSamples: Int,
                 ...
                 fftBands: Int?) -> WaveformSeekBarAnalysis {
        ...
        return WaveformSeekBarAnalysis(amplitudes: normalize(targetSamples), fft: outputFFT)
    }
...
// MARK: - Configuration
private extension WaveformSeekBarAnalyzer {
